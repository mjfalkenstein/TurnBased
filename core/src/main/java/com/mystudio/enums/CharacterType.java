...
public enum CharacterType {
	...
	PRODIGY,			//one with amazing intellect, has forgone physical prowess for a powerful exoskeleton with a medium ranged rifle
	...
	VISIONARY,			//A fully realized prodigy, uses their enormous brain power to control a mech, uses shotguns for close-range combat
